...
public class OfferEventInfoModel {
  /**
  ...
  /**
   * Gets or Sets parentEventType
   */
  public enum ParentEventTypeEnum {
    ONPURCHASECALCULATE("OnPurchaseCalculate"),
    ...
    ParentEventTypeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ParentEventTypeEnum fromValue(String text) {
      for (ParentEventTypeEnum b : ParentEventTypeEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
  ...
  @JsonProperty("parentEventType")
  private ParentEventTypeEnum parentEventType = null;

  public OfferEventInfoModel eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public OfferEventInfoModel parentActionId(Integer parentActionId) {
  ...
  **/
  ...
  public OfferEventInfoModel parentEventType(ParentEventTypeEnum parentEventType) {
  ...
  **/
  @ApiModelProperty(value = "")
  public ParentEventTypeEnum getParentEventType() {
    return parentEventType;
  }

  public void setParentEventType(ParentEventTypeEnum parentEventType) {
    this.parentEventType = parentEventType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OfferEventInfoModel offerEventInfoModel = (OfferEventInfoModel) o;
    return Objects.equals(this.eventType, offerEventInfoModel.eventType) &&
        Objects.equals(this.parentActionId, offerEventInfoModel.parentActionId) &&
        Objects.equals(this.parentEventType, offerEventInfoModel.parentEventType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventType, parentActionId, parentEventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class OfferEventInfoModel {\n");
    
    sb.append("    eventType: ").append(toIndentedString(eventType)).append("\n");
    sb.append("    parentActionId: ").append(toIndentedString(parentActionId)).append("\n");
    sb.append("    parentEventType: ").append(toIndentedString(parentEventType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
