...
import com.example.demo.restclient.auth.Authentication;
import com.example.demo.restclient.auth.HttpBasicAuth;
import com.example.demo.restclient.auth.ApiKeyAuth;
import com.example.demo.restclient.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-25T13:30:11.810+03:00")
@Component("com.example.demo.restclient.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://sparmv-stg.loymax.tech/systemapi";
    ...
    protected void init() {
        ...
        authentications.put("OAuth2Code", new OAuth());
        authentications.put("OAuth2Password", new OAuth());
    ...
    */
    ...
    public boolean isJsonMime(MediaType mediaType) {
        return mediaType != null && (MediaType.APPLICATION_FORM_URLENCODED.isCompatibleWith(mediaType) || mediaType.getSubtype().matches("^.*\\+json[;]?\\s*$"));
    }
    ...
    public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames, ParameterizedTypeReference<T> returnType) throws RestClientException {
        ...
        System.out.println(body+ "body Из метода invokeAPI класса ApiClient");
        RequestEntity<Object> requestEntity = requestBuilder.body(selectBody(body, formParams, contentType));
        System.out.println(requestEntity +"Из метода invokeAPI класса ApiClient"+ returnType);
