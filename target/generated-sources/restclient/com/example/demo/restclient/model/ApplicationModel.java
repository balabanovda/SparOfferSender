 ...
 */
@ApiModel(description = "Модель OAuth приложения.")
...
public class ApplicationModel {
  ...
  **/
  ...
  public ApplicationModel alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  **/
  ...
  public ApplicationModel isDeleted(Boolean isDeleted) {
  ...
  **/
  ...
  public ApplicationModel redirects(List<String> redirects) {
    this.redirects = redirects;
    return this;
  }

  public ApplicationModel addRedirectsItem(String redirectsItem) {
  ...
  **/
  ...
  public ApplicationModel partnerId(Integer partnerId) {
  ...
  **/
  ...
  public ApplicationModel device(DeviceBaseViewModel device) {
    this.device = device;
    return this;
  }
  ...
  **/
  ...
  public ApplicationModel cssUri(String cssUri) {
    this.cssUri = cssUri;
    return this;
  }
  ...
  **/
  ...
  public ApplicationModel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ApplicationModel partnerName(String partnerName) {
   ...
   * @return partnerName
  **/
  @ApiModelProperty(value = "Имя партнера.")
  ...
  public ApplicationModel loyaltyProgram(PartnerLoyaltyProgramModel loyaltyProgram) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, applicationModel.name) &&
        Objects.equals(this.alias, applicationModel.alias) &&
        Objects.equals(this.description, applicationModel.description) &&
        Objects.equals(this.isDeleted, applicationModel.isDeleted) &&
        Objects.equals(this.redirects, applicationModel.redirects) &&
        Objects.equals(this.partnerId, applicationModel.partnerId) &&
        Objects.equals(this.device, applicationModel.device) &&
        Objects.equals(this.cssUri, applicationModel.cssUri) &&
        Objects.equals(this.id, applicationModel.id) &&
        Objects.equals(this.partnerName, applicationModel.partnerName) &&
        Objects.equals(this.loyaltyProgram, applicationModel.loyaltyProgram);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, alias, description, isDeleted, redirects, partnerId, device, cssUri, id, partnerName, loyaltyProgram);
  }
