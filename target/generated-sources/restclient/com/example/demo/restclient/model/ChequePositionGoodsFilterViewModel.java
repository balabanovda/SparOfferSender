...
import com.example.demo.restclient.model.GoodsGroupsFilterWithConditionViewModel;
 ...
 */
@ApiModel(description = "ViewModel для фильтра \"Товар\".")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-25T13:30:11.810+03:00")
public class ChequePositionGoodsFilterViewModel {
  /**
   * Тип фильтрации.
   */
  ...
  public ChequePositionGoodsFilterViewModel type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel operation(OperationEnum operation) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel firstValue(Double firstValue) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel secondValue(Double secondValue) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel goodsGroups(List<GoodsGroupViewModel> goodsGroups) {
    this.goodsGroups = goodsGroups;
    return this;
  }

  public ChequePositionGoodsFilterViewModel addGoodsGroupsItem(GoodsGroupViewModel goodsGroupsItem) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel personalOfferAttributeId(Integer personalOfferAttributeId) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel isDeletedFilterType(Boolean isDeletedFilterType) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel dividePositions(Boolean dividePositions) {
  ...
  **/
  ...
  public ChequePositionGoodsFilterViewModel chequeGoodsSortType(ChequeGoodsSortTypeEnum chequeGoodsSortType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChequePositionGoodsFilterViewModel chequePositionGoodsFilterViewModel = (ChequePositionGoodsFilterViewModel) o;
    return Objects.equals(this.type, chequePositionGoodsFilterViewModel.type) &&
        Objects.equals(this.operation, chequePositionGoodsFilterViewModel.operation) &&
        Objects.equals(this.firstValue, chequePositionGoodsFilterViewModel.firstValue) &&
        Objects.equals(this.secondValue, chequePositionGoodsFilterViewModel.secondValue) &&
        Objects.equals(this.goodsGroups, chequePositionGoodsFilterViewModel.goodsGroups) &&
        Objects.equals(this.personalOfferAttributeId, chequePositionGoodsFilterViewModel.personalOfferAttributeId) &&
        Objects.equals(this.id, chequePositionGoodsFilterViewModel.id) &&
        Objects.equals(this.name, chequePositionGoodsFilterViewModel.name) &&
        Objects.equals(this.isDeletedFilterType, chequePositionGoodsFilterViewModel.isDeletedFilterType) &&
        Objects.equals(this.dividePositions, chequePositionGoodsFilterViewModel.dividePositions) &&
        Objects.equals(this.chequeGoodsSortType, chequePositionGoodsFilterViewModel.chequeGoodsSortType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, operation, firstValue, secondValue, goodsGroups, personalOfferAttributeId, id, name, isDeletedFilterType, dividePositions, chequeGoodsSortType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChequePositionGoodsFilterViewModel {\n");
