...
public class CommunicationPersonalGoodsOfferModel {
  ...
  public CommunicationPersonalGoodsOfferModel brandIds(List<Integer> brandIds) {
    this.brandIds = brandIds;
    return this;
  }

  public CommunicationPersonalGoodsOfferModel addBrandIdsItem(Integer brandIdsItem) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel description(String description) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel shortDescription(String shortDescription) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel begin(OffsetDateTime begin) {
    this.begin = begin;
    return this;
  }
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel end(OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel rewardThumbnail(RewardThumbnailModel rewardThumbnail) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel images(List<ImageViewModel> images) {
    this.images = images;
    return this;
  }

  public CommunicationPersonalGoodsOfferModel addImagesItem(ImageViewModel imagesItem) {
    if (this.images == null) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel rewardImage(FileViewModel rewardImage) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel merchantIds(List<Integer> merchantIds) {
    this.merchantIds = merchantIds;
    return this;
  }

  public CommunicationPersonalGoodsOfferModel addMerchantIdsItem(Integer merchantIdsItem) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel targetGroupIds(List<Integer> targetGroupIds) {
    this.targetGroupIds = targetGroupIds;
    return this;
  }

  public CommunicationPersonalGoodsOfferModel addTargetGroupIdsItem(Integer targetGroupIdsItem) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel isArchived(Boolean isArchived) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel priority(Integer priority) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel categories(List<SimpleCategoryViewModel> categories) {
    this.categories = categories;
    return this;
  }

  public CommunicationPersonalGoodsOfferModel addCategoriesItem(SimpleCategoryViewModel categoriesItem) {
  ...
  **/
  ...
  public CommunicationPersonalGoodsOfferModel personalOfferAttributeId(Integer personalOfferAttributeId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CommunicationPersonalGoodsOfferModel communicationPersonalGoodsOfferModel = (CommunicationPersonalGoodsOfferModel) o;
    return Objects.equals(this.brandIds, communicationPersonalGoodsOfferModel.brandIds) &&
        Objects.equals(this.id, communicationPersonalGoodsOfferModel.id) &&
        Objects.equals(this.title, communicationPersonalGoodsOfferModel.title) &&
        Objects.equals(this.description, communicationPersonalGoodsOfferModel.description) &&
        Objects.equals(this.shortDescription, communicationPersonalGoodsOfferModel.shortDescription) &&
        Objects.equals(this.begin, communicationPersonalGoodsOfferModel.begin) &&
        Objects.equals(this.end, communicationPersonalGoodsOfferModel.end) &&
        Objects.equals(this.rewardThumbnail, communicationPersonalGoodsOfferModel.rewardThumbnail) &&
        Objects.equals(this.images, communicationPersonalGoodsOfferModel.images) &&
        Objects.equals(this.rewardImage, communicationPersonalGoodsOfferModel.rewardImage) &&
        Objects.equals(this.merchantIds, communicationPersonalGoodsOfferModel.merchantIds) &&
        Objects.equals(this.targetGroupIds, communicationPersonalGoodsOfferModel.targetGroupIds) &&
        Objects.equals(this.isArchived, communicationPersonalGoodsOfferModel.isArchived) &&
        Objects.equals(this.priority, communicationPersonalGoodsOfferModel.priority) &&
        Objects.equals(this.categories, communicationPersonalGoodsOfferModel.categories) &&
        Objects.equals(this.personalOfferAttributeId, communicationPersonalGoodsOfferModel.personalOfferAttributeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandIds, id, title, description, shortDescription, begin, end, rewardThumbnail, images, rewardImage, merchantIds, targetGroupIds, isArchived, priority, categories, personalOfferAttributeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommunicationPersonalGoodsOfferModel {\n");
