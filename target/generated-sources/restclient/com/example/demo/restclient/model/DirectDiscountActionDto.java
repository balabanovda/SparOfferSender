...
import com.example.demo.restclient.model.AmountActionDto;
import com.example.demo.restclient.model.AttributeDiscountDto;
...
/**
 * Действие акции \&quot;Скидка\&quot;.
 */
@ApiModel(description = "Действие акции \"Скидка\".")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-25T13:30:11.810+03:00")
public class DirectDiscountActionDto {
  ...
  public DirectDiscountActionDto percent(Double percent) {
  ...
  **/
  ...
  public DirectDiscountActionDto amountPerUnit(Double amountPerUnit) {
  ...
  **/
  ...
  public DirectDiscountActionDto amountPerUniqueSku(Double amountPerUniqueSku) {
  ...
  **/
  ...
  public DirectDiscountActionDto pricePerUnit(Double pricePerUnit) {
  ...
  **/
  ...
  public DirectDiscountActionDto amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public DirectDiscountActionDto amountMeasure(Double amountMeasure) {
  ...
  **/
  ...
  public DirectDiscountActionDto amountPerMeasure(Double amountPerMeasure) {
  ...
  **/
  ...
  public DirectDiscountActionDto amountWeight(Double amountWeight) {
  ...
  **/
  ...
  public DirectDiscountActionDto amountPerWeight(Double amountPerWeight) {
  ...
  **/
  ...
  public DirectDiscountActionDto price(Double price) {
    this.price = price;
    return this;
  }
  ...
  **/
  ...
  public DirectDiscountActionDto attributeDiscount(AttributeDiscountDto attributeDiscount) {
  ...
  **/
  ...
  public DirectDiscountActionDto distributeToAll(Boolean distributeToAll) {
  ...
  **/
  ...
  public DirectDiscountActionDto discountType(DiscountTypeEnum discountType) {
  ...
  **/
  ...
  public DirectDiscountActionDto calculationExclusionDiscountTypes(List<CalculationExclusionDiscountTypesEnum> calculationExclusionDiscountTypes) {
    this.calculationExclusionDiscountTypes = calculationExclusionDiscountTypes;
    return this;
  }

  public DirectDiscountActionDto addCalculationExclusionDiscountTypesItem(CalculationExclusionDiscountTypesEnum calculationExclusionDiscountTypesItem) {
  ...
  **/
  ...
  public DirectDiscountActionDto order(Integer order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public DirectDiscountActionDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DirectDiscountActionDto directDiscountActionDto = (DirectDiscountActionDto) o;
    return Objects.equals(this.percent, directDiscountActionDto.percent) &&
        Objects.equals(this.amountPerUnit, directDiscountActionDto.amountPerUnit) &&
        Objects.equals(this.amountPerUniqueSku, directDiscountActionDto.amountPerUniqueSku) &&
        Objects.equals(this.pricePerUnit, directDiscountActionDto.pricePerUnit) &&
        Objects.equals(this.amount, directDiscountActionDto.amount) &&
        Objects.equals(this.amountMeasure, directDiscountActionDto.amountMeasure) &&
        Objects.equals(this.amountPerMeasure, directDiscountActionDto.amountPerMeasure) &&
        Objects.equals(this.amountWeight, directDiscountActionDto.amountWeight) &&
        Objects.equals(this.amountPerWeight, directDiscountActionDto.amountPerWeight) &&
        Objects.equals(this.price, directDiscountActionDto.price) &&
        Objects.equals(this.attributeDiscount, directDiscountActionDto.attributeDiscount) &&
        Objects.equals(this.distributeToAll, directDiscountActionDto.distributeToAll) &&
        Objects.equals(this.discountType, directDiscountActionDto.discountType) &&
        Objects.equals(this.calculationExclusionDiscountTypes, directDiscountActionDto.calculationExclusionDiscountTypes) &&
        Objects.equals(this.order, directDiscountActionDto.order) &&
        Objects.equals(this.id, directDiscountActionDto.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(percent, amountPerUnit, amountPerUniqueSku, pricePerUnit, amount, amountMeasure, amountPerMeasure, amountWeight, amountPerWeight, price, attributeDiscount, distributeToAll, discountType, calculationExclusionDiscountTypes, order, id);
  }
