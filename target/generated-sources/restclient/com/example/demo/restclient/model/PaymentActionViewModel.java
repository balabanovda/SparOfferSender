 ...
 */
@ApiModel(description = "Модель для действия \"Оплата\".")
...
public class PaymentActionViewModel {
  ...
  public PaymentActionViewModel percent(Double percent) {
  ...
  **/
  ...
  public PaymentActionViewModel pricePerUnit(Double pricePerUnit) {
  ...
  **/
  ...
  public PaymentActionViewModel amountPerUnit(Double amountPerUnit) {
  ...
  **/
  ...
  public PaymentActionViewModel amountPerUniqueSku(Double amountPerUniqueSku) {
  ...
  **/
  ...
  public PaymentActionViewModel amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public PaymentActionViewModel amountMeasure(Double amountMeasure) {
  ...
  **/
  ...
  public PaymentActionViewModel amountPerMeasure(Double amountPerMeasure) {
  ...
  **/
  ...
  public PaymentActionViewModel amountWeight(Double amountWeight) {
  ...
  **/
  ...
  public PaymentActionViewModel amountPerWeight(Double amountPerWeight) {
  ...
  **/
  ...
  public PaymentActionViewModel price(Double price) {
    this.price = price;
    return this;
  }
  ...
  **/
  ...
  public PaymentActionViewModel attributeDiscount(AttributeDiscount attributeDiscount) {
  ...
  **/
  ...
  public PaymentActionViewModel distributeToAll(Boolean distributeToAll) {
  ...
  **/
  ...
  public PaymentActionViewModel calculationExclusionDiscountTypes(List<CalculationExclusionDiscountTypesEnum> calculationExclusionDiscountTypes) {
    this.calculationExclusionDiscountTypes = calculationExclusionDiscountTypes;
    return this;
  }

  public PaymentActionViewModel addCalculationExclusionDiscountTypesItem(CalculationExclusionDiscountTypesEnum calculationExclusionDiscountTypesItem) {
  ...
  **/
  ...
  public PaymentActionViewModel actionId(Integer actionId) {
  ...
  **/
  ...
  public PaymentActionViewModel order(Integer order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public PaymentActionViewModel currency(CurrencyViewModel currency) {
  ...
  **/
  ...
  public PaymentActionViewModel rate(Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentActionViewModel paymentActionViewModel = (PaymentActionViewModel) o;
    return Objects.equals(this.percent, paymentActionViewModel.percent) &&
        Objects.equals(this.pricePerUnit, paymentActionViewModel.pricePerUnit) &&
        Objects.equals(this.amountPerUnit, paymentActionViewModel.amountPerUnit) &&
        Objects.equals(this.amountPerUniqueSku, paymentActionViewModel.amountPerUniqueSku) &&
        Objects.equals(this.amount, paymentActionViewModel.amount) &&
        Objects.equals(this.amountMeasure, paymentActionViewModel.amountMeasure) &&
        Objects.equals(this.amountPerMeasure, paymentActionViewModel.amountPerMeasure) &&
        Objects.equals(this.amountWeight, paymentActionViewModel.amountWeight) &&
        Objects.equals(this.amountPerWeight, paymentActionViewModel.amountPerWeight) &&
        Objects.equals(this.price, paymentActionViewModel.price) &&
        Objects.equals(this.attributeDiscount, paymentActionViewModel.attributeDiscount) &&
        Objects.equals(this.distributeToAll, paymentActionViewModel.distributeToAll) &&
        Objects.equals(this.calculationExclusionDiscountTypes, paymentActionViewModel.calculationExclusionDiscountTypes) &&
        Objects.equals(this.actionId, paymentActionViewModel.actionId) &&
        Objects.equals(this.order, paymentActionViewModel.order) &&
        Objects.equals(this.currency, paymentActionViewModel.currency) &&
        Objects.equals(this.rate, paymentActionViewModel.rate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(percent, pricePerUnit, amountPerUnit, amountPerUniqueSku, amount, amountMeasure, amountPerMeasure, amountWeight, amountPerWeight, price, attributeDiscount, distributeToAll, calculationExclusionDiscountTypes, actionId, order, currency, rate);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentActionViewModel {\n");
