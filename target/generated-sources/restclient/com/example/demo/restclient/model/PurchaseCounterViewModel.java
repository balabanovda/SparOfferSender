 ...
 */
@ApiModel(description = "Модель представления для счетчика, связанного с покупкой.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-25T13:30:11.810+03:00")
public class PurchaseCounterViewModel {
  @JsonProperty("id")
  ...
  public PurchaseCounterViewModel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PurchaseCounterViewModel uid(UUID uid) {
    this.uid = uid;
    return this;
  }
  ...
  **/
  ...
  public PurchaseCounterViewModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public PurchaseCounterViewModel author(CreatorModel author) {
    this.author = author;
    return this;
  }
  ...
  **/
  ...
  public PurchaseCounterViewModel creationDate(OffsetDateTime creationDate) {
  ...
  **/
  ...
  public PurchaseCounterViewModel partner(PartnerViewModel partner) {
  ...
  **/
  ...
  public PurchaseCounterViewModel targets(List<TargetsEnum> targets) {
    this.targets = targets;
    return this;
  }

  public PurchaseCounterViewModel addTargetsItem(TargetsEnum targetsItem) {
  ...
  **/
  ...
  public PurchaseCounterViewModel loyaltyProgram(LoyaltyProgramModel loyaltyProgram) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PurchaseCounterViewModel purchaseCounterViewModel = (PurchaseCounterViewModel) o;
    return Objects.equals(this.id, purchaseCounterViewModel.id) &&
        Objects.equals(this.uid, purchaseCounterViewModel.uid) &&
        Objects.equals(this.name, purchaseCounterViewModel.name) &&
        Objects.equals(this.author, purchaseCounterViewModel.author) &&
        Objects.equals(this.creationDate, purchaseCounterViewModel.creationDate) &&
        Objects.equals(this.partner, purchaseCounterViewModel.partner) &&
        Objects.equals(this.targets, purchaseCounterViewModel.targets) &&
        Objects.equals(this.loyaltyProgram, purchaseCounterViewModel.loyaltyProgram);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurchaseCounterViewModel {\n");
