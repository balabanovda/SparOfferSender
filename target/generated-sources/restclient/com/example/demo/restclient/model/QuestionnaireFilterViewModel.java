...
import com.example.demo.restclient.model.QuestionnaireFilterBaseViewModel;
 ...
 */
@ApiModel(description = "Фильтр по анкете пользователя.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-25T13:30:11.810+03:00")
public class QuestionnaireFilterViewModel {
  ...
  public QuestionnaireFilterViewModel questionId(Integer questionId) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel operation(OperationEnum operation) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel firstIntValue(Integer firstIntValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel secondIntValue(Integer secondIntValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel firstDoubleValue(Double firstDoubleValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel secondDoubleValue(Double secondDoubleValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel firstDateValue(OffsetDateTime firstDateValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel secondDateValue(OffsetDateTime secondDateValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel stringValue(String stringValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel fixedAnswerIds(List<Integer> fixedAnswerIds) {
    this.fixedAnswerIds = fixedAnswerIds;
    return this;
  }

  public QuestionnaireFilterViewModel addFixedAnswerIdsItem(Integer fixedAnswerIdsItem) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel fixedAnswerNames(List<String> fixedAnswerNames) {
    this.fixedAnswerNames = fixedAnswerNames;
    return this;
  }

  public QuestionnaireFilterViewModel addFixedAnswerNamesItem(String fixedAnswerNamesItem) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel boolValue(Boolean boolValue) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel questionType(QuestionTypeEnum questionType) {
  ...
  **/
  ...
  public QuestionnaireFilterViewModel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public QuestionnaireFilterViewModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public QuestionnaireFilterViewModel isDeletedFilterType(Boolean isDeletedFilterType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QuestionnaireFilterViewModel questionnaireFilterViewModel = (QuestionnaireFilterViewModel) o;
    return Objects.equals(this.questionId, questionnaireFilterViewModel.questionId) &&
        Objects.equals(this.operation, questionnaireFilterViewModel.operation) &&
        Objects.equals(this.firstIntValue, questionnaireFilterViewModel.firstIntValue) &&
        Objects.equals(this.secondIntValue, questionnaireFilterViewModel.secondIntValue) &&
        Objects.equals(this.firstDoubleValue, questionnaireFilterViewModel.firstDoubleValue) &&
        Objects.equals(this.secondDoubleValue, questionnaireFilterViewModel.secondDoubleValue) &&
        Objects.equals(this.firstDateValue, questionnaireFilterViewModel.firstDateValue) &&
        Objects.equals(this.secondDateValue, questionnaireFilterViewModel.secondDateValue) &&
        Objects.equals(this.stringValue, questionnaireFilterViewModel.stringValue) &&
        Objects.equals(this.fixedAnswerIds, questionnaireFilterViewModel.fixedAnswerIds) &&
        Objects.equals(this.fixedAnswerNames, questionnaireFilterViewModel.fixedAnswerNames) &&
        Objects.equals(this.boolValue, questionnaireFilterViewModel.boolValue) &&
        Objects.equals(this.questionType, questionnaireFilterViewModel.questionType) &&
        Objects.equals(this.id, questionnaireFilterViewModel.id) &&
        Objects.equals(this.name, questionnaireFilterViewModel.name) &&
        Objects.equals(this.isDeletedFilterType, questionnaireFilterViewModel.isDeletedFilterType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(questionId, operation, firstIntValue, secondIntValue, firstDoubleValue, secondDoubleValue, firstDateValue, secondDateValue, stringValue, fixedAnswerIds, fixedAnswerNames, boolValue, questionType, id, name, isDeletedFilterType);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuestionnaireFilterViewModel {\n");
